...
@recipes = [
  ...
  {
    title: "Черничные панкейки с корицей",
    portions: 4,
    time: "30 минут",
    difficulty: "Легко",
    nutritions: "366 калорий",
...
@steps = [
  {
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe1_1.png'))
  }, {
    recipe_id: 1,
    position: 2,
    description: "Помидоры нарезать кубиками с ребром около полсантиметра. Мелко нарубить три зубчика чеснока.",
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe1_2.png'))
  }, {
    recipe_id: 1,
    position: 3,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe1_3.png'))
  }, {
    recipe_id: 1,
    position: 4,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe1_4.png'))
  }, {
    recipe_id: 2,
    position: 1,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_1.jpg'))
  }, {
    recipe_id: 2,
    position: 2,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_2.jpg'))
  }, {
    recipe_id: 2,
    position: 3,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_3.jpg'))
  }, {
    recipe_id: 2,
    position: 4,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_4.jpg'))
  }, {
    recipe_id: 2,
    position: 5,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_5.jpg'))
  }, {
    recipe_id: 2,
    position: 6,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_6.jpg'))
  }, {
    recipe_id: 2,
    position: 7,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_7.jpg'))
  }, {
    recipe_id: 2,
    position: 8,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe2_8.jpg'))
  }, {
    recipe_id: 3,
    position: 1,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_1.jpg'))
  }, {
    recipe_id: 3,
    position: 2,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_2.jpg'))
  }, {
    recipe_id: 3,
    position: 3,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_3.jpg'))
  }, {
    recipe_id: 3,
    position: 4,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_4.jpg'))
  }, {
    recipe_id: 3,
    position: 5,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_5.jpg'))
  }, {
    recipe_id: 3,
    position: 6,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_6.jpg'))
  }, {
    recipe_id: 3,
    position: 7,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_7.jpg'))
  }, {
    recipe_id: 3,
    position: 8,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe3_8.jpg'))
  }, {
    recipe_id: 6,
    position: 1,
    description: "Отделить белки от желтков. Белки убрать в холодильник, а желтки выложить в глубокую и широкую миску, добавить к ним сахар, пару щепоток моло- той корицы и растереть до однородной массы.",
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe4_1.jpg'))
  }, {
    recipe_id: 4,
    position: 2,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe4_2.jpg'))
  }, {
    recipe_id: 4,
    position: 3,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe4_3.jpg'))
  }, {
    recipe_id: 5,
    position: 1,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe5_1.png'))
  }, {
    recipe_id: 5,
    position: 2,
    ...
    step_image: File.open(File.join(Rails.root,'db/images/steps/recipe5_2.png'))
  }
]
